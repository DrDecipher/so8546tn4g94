...
/// Sourced from:
/// https://jacksondunstan.com/articles/5416
///  
/// Note: I've modified the 2D version to this 3D version for future use.
namespace Extensions.NativeCollections
{
    /// <summary>
    ...
    public unsafe struct NativeArray3D<T>
        : IDisposable
        , IEnumerable<T>
...
#endif
    {
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            /// <summary>
            /// Current index in the third dimension
            /// </summary>
            ...
            public T Current
            {
                get
                {
                    return m_Array[m_Index0, m_Index1, m_Index2];
                }
            }
        ...
        /// <summary>
        /// Length of the array's third dimension
        /// </summary>
        ...
        /// 
        /// <param name="length2">
        /// Length of the array's third dimension. Must be positive.
        /// </param>
        /// 
        ...
        {
            Allocate(array.Length0, array.Length1, array.Length2, allocator, out this);
            Copy(array, this);
        }
        ...
        public int Length
        {
            get
            {
                return m_Length0 * m_Length1 * m_Length2;
            }
        }
        ...
        /// </summary>
        [Conditional("ENABLE_UNITY_COLLECTIONS_CHECKS")]
        private void RequireIndexInBounds(int index0, int index1, int index2)
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        ...
        public T this[int index0, int index1, int index2]
        {
            ...
            {
                RequireReadAccess();
                RequireIndexInBounds(index0, index1, index2);

                int index = index2 *( index1+ m_Length1) *( m_Length0 + index0);
        ...
        public T[,,] ToArray()
        {
            T[,,] dst = new T[m_Length0, m_Length1, m_Length2];
            Copy(this, dst);
            return dst;
        }
        ...
        private static void Copy(NativeArray3D<T> src, NativeArray3D<T> dest)
        {
            ...
            for (int index0 = 0; index0 < src.Length0; ++index0)
            {
                ...
                {
                    for (int index2 = 0; index2 < src.Length2; ++index2)
                    {
        ...
        private static void Copy(T[,,] src, NativeArray3D<T> dest)
        {
            ...
            for (int index0 = 0; index0 < dest.Length0; ++index0)
            {
                ...
                {
                    for (int index2 = 0; index2 < dest.Length2; ++index2)
                    {
                        dest[index0, index1, index2] = src[index0, index1, index2];
                    }
                }
